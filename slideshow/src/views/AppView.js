...
define(function(require, exports, module) {
  ...
  AppView.DEFAULT_OPTIONS = {
    ...
    data: undefined,
    cameraWidth: 0.5 * window.innerHeight // not ideal you'd rathher size according to parent context
  };
  ...
  AppView.DEFAULT_OPTIONS.slidePosition = .77 * AppView.DEFAULT_OPTIONS.cameraWidth;
